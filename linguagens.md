...
| C#          | Multiparadigma / OO           | Sistemas corporativos e jogos (Unity)           | Threads gerenciadas (Thread), Pool de Threads e async/await                   | [Microsoft .NET](https://dotnet.microsoft.com/pt-br/languages/csharp) |
| C++         | Multiparadigma / Sistemas     | Software de alto desempenho e jogos AAA         | Threads de sistema operacional nativas (std::thread, std::jthread)             | [CPP Reference](https://cppreference.com/) |
| Clojure     | Funcional                     | Processamento de dados na JVM                   | Software Transactional Memory (STM), Agents e Atoms                            | [Clojure](https://clojure.org/) |
| Elixir      | Funcional / Atores            | Sistemas web distribuídos de alta escala        | Processos ultra-leves na BEAM VM (Modelo de Atores com isolamento total)       | [Elixir](https://elixir-lang.org/) |
| Erlang      | Funcional / Atores            | Telecomunicações e sistemas tolerantes a falhas | Processos ultra-leves na BEAM VM (Passagem de mensagens assíncronas)           | [Erlang](https://www.erlang.org/) |
| F#          | Funcional                     |                                                 |                                                                                | [F# Lang](https://fsharp.org/) [Microsoft F#](https://dotnet.microsoft.com/pt-br/languages/fsharp) |
| Go (Golang) | Imperativo / Concorrente      | Microsserviços e infraestrutura de nuvem        | Goroutines (Múltiplas Green Threads mapeadas em threads de S.O. via canais)    | [Go Dev](https://go.dev/) |
| Haskell     | Funcional Puro                | Pesquisa acadêmica e sistemas financeiros       | Software Transactional Memory (STM) e Green Threads leves gerenciadas pelo GHC | [Haskell](https://www.haskell.org/) |
| Java        | Orientado a Objetos           | Aplicações corporativas e bancárias             | Threads de S.O. tradicionais e Virtual Threads (Projeto Loom, Green Threads modernas) | Java [Dev](https://dev.java/) [Oracle](https://docs.oracle.com/en/java/javase/) |
| Kotlin      | Multiparadigma / OO           | Desenvolvimento Android e Backend               | Corrotinas (Concorrência estruturada suspensiva sem bloquear threads de S.O.) | [Kotlin](https://kotlinlang.org/) |
| Lua         | Multiparadigma / Script       | Linguagem de extensão embutida em jogos/C       | Corrotinas cooperativas (Concorrência assimétrica dentro de uma única thread) | [Lua](https://www.lua.org/) |
| OCaml       | Funcional Multiparadigma      | Ferramentas estáticas e finanças quantitativas  | Multicore OCaml (Threads em paralelo reais e Efeitos Algébricos desde a v5.0) | [OCaml](https://ocaml.org/) |
| PHP         | Multiparadigma / Web          | Criação de sites e APIs web dinâmicas           | Nativamente single-threaded, mas suporta Threads Reais isoladas (Extensão parallel)         | [PHP](https://www.php.net/) |
| Rust        | Imperativo / Sistemas         | Infraestrutura de rede e segurança de memória   | Threads nativas com garantia de ausência de data races em compilação (Fearless Concurrency) | [Rust](https://rust-lang.org/) |
| Scala       | Híbrido Puro (OO + Funcional) | Processamento de Big Data (Apache Spark)        | Modelo de Atores (via ecossistemas como Akka/Pekko) construído sobre a JVM                  | [Scala](https://www.scala-lang.org/) |
...
| TypeScript  | Multiparadigma / Estático     | Aplicações web complexas front/backend          | Execução Single-threaded baseada em Loop de Eventos; concorrência via Worker Threads        | [TypeScript](https://www.typescriptlang.org/) |
| Zig         | Imperativo / Sistemas         | Programação de baixo nível (sucessor do C)      | Threads nativas do S.O. gerenciadas manualmente sem runtime oculto                          | [Zig](https://ziglang.org/) |
